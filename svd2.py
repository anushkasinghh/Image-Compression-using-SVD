# -*- coding: utf-8 -*-
"""
Created on Fri Jan  7 03:31:47 2022
...
def img_to_matrix_rgb():
    ...
    #open image
    mats=np.array(img.open('ok1.jpeg'))
...
def img_to_matrix_gray():
    ...
    mats=np.array(img.open('123.jpg'))
    mat=mats[:5700,:5700]
    print(mat)
    return mat
...
def compress_rgb_image(p):
    ...
    temp_img= img.merge('RGB',(imr,imgr,imb)).save('uncool_rohit.png')

#m=img_to_matrix_gray()
#print(m)
#for i in range(0,100,25):
compress_rgb_image(0.2)
